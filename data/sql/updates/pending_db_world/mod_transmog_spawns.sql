...
-- Source: `SELECT * FROM acore_world_ptr.creature WHERE id = 190010` (3 rows,
-- verified 2026-07-04) — exact position/orientation copy from PTR, where a GM
-- placed these spawns during testing (2026-07-02..04).
--
-- NOTE: uses the post-2026_06_16_00 `creature` schema (id1 -> id, id2/id3 moved
-- to `creature_multispawn`). Apply only after that core update.
--
...
VALUES
  (5300725, 190010, 0, 0, 0, 1, 1, 0, -8841.09, 637.145, 95.0508, 2.31021,
   300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL, 0, 'Warpweaver - live promotion from PTR GM spawn'),
  (5300728, 190010, 0, 0, 0, 1, 1, 0, -8941.97, 778.907, 89.8481, 4.5538,
   300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL, 0, 'Warpweaver - live promotion from PTR GM spawn'),
  (5300731, 190010, 0, 0, 0, 1, 1, 0, -11346.5, -217.08, 75.2798, 0.663931,
   300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL, 0, 'Warpweaver - live promotion from PTR GM spawn');
