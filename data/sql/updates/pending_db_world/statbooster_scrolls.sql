...
-- Blacksmithing
(100001, 'ruRU', 'Рунный точильный камень',       'Используйте на снаряжении (лвл 1-25) для наложения боевых чар.'),
(100002, 'ruRU', 'Закаленный точильный камень',    'Используйте на снаряжении (лвл 26-45) для наложения боевых чар.'),
(100003, 'ruRU', 'Отточенный точильный камень',    'Используйте на снаряжении (лвл 46-65) для наложения боевых чар.'),
(100004, 'ruRU', 'Мастерский точильный камень',    'Используйте на снаряжении (лвл 66-92) для наложения боевых чар.'),
-- Leatherworking
(100005, 'ruRU', 'Рунная нашивка',                 'Используйте на снаряжении (лвл 1-25) для наложения защитных чар.'),
(100006, 'ruRU', 'Закаленная нашивка',             'Используйте на снаряжении (лвл 26-45) для наложения защитных чар.'),
(100007, 'ruRU', 'Упрочненная нашивка',            'Используйте на снаряжении (лвл 46-65) для наложения защитных чар.'),
(100008, 'ruRU', 'Мастерская нашивка',             'Используйте на снаряжении (лвл 66-92) для наложения защитных чар.'),
-- Enchanting
(100009, 'ruRU', 'Малый тайный пергамент',         'Используйте на снаряжении (лвл 1-25) для наложения чар заклинателя.'),
(100010, 'ruRU', 'Тайный пергамент',               'Используйте на снаряжении (лвл 26-45) для наложения чар заклинателя.'),
(100011, 'ruRU', 'Большой тайный пергамент',       'Используйте на снаряжении (лвл 46-65) для наложения чар заклинателя.'),
(100012, 'ruRU', 'Превосходный тайный пергамент',  'Используйте на снаряжении (лвл 66-92) для наложения чар заклинателя.'),
-- Inscription
(100013, 'ruRU', 'Малый символ удачи',             'Используйте на снаряжении (лвл 1-25) для наложения особого эффекта.'),
(100014, 'ruRU', 'Символ удачи',                   'Используйте на снаряжении (лвл 26-45) для наложения особого эффекта.'),
(100015, 'ruRU', 'Большой символ удачи',           'Используйте на снаряжении (лвл 46-65) для наложения особого эффекта.'),
(100016, 'ruRU', 'Великий символ удачи',           'Используйте на снаряжении (лвл 66-92) для наложения особого эффекта.');
