...
Универсальная сумка `110120` и «Монета авантюриста» `110150` — без изменений. `110110–110119` свободны.

## Шансы выпадения (LIVE на PTR 2026-06-07)

- **Универсальная «Сумка Авантюриста»** (item 110120) — 1 монета авантюриста. Пул: все 100. **89% C / 10% R / 1% E**. На одного петомца: C 1.483%, R 0.333%, E 0.100%.
- **Сумка семейства «<Стихия> сумка»** (110100–110109) — 5 монет. Пул: 10 петомцев своей стихии. **75% C / 20% R / 5% E**. На одного петомца: C 12.5%, R 6.67%, E 5.00%.
- Сумка семейства даёт нужный Epic с вероятностью **5%** против **0.1%** в универсальной → соотношение **×50** за **×5** цены.
