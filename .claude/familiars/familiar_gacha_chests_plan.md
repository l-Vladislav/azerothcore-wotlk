...
- **Продажа у мастера таверны** (решение владельца 2026-06-07): тот же NPC,
  что продаёт предметы за жетоны немезиды, с отдельными гослип-ПОДМЕНЮ по
  рангам немезиды: ранг 1 — общие товары, ранг 2 — StatBooster
  (печати/нашивки), ранг 3 — сумки с фамильярами. Цены: универсальная
  1 «Монета авантюриста», сумка семейства — 5.
- **Особые задания** (Фаза 7): источник монеты, не больше 1/день.
  До этого монета GM-only.
