...
### Охотничий контур v2 (2026-06-07, НЕ ЗАКОММИЧЕНО — ревью владельца)
Полный дизайн: [nemesis_hunting_loop.md](nemesis_hunting_loop.md). Сверх описанного
ниже в diff'е модуля: поручение дня НАЗНАЧАЕТСЯ (ролл guid⊕день, без выбора);
награды поручений всегда 1 монета; зачистка данжа с порогом ≥3 убийств и
прогрессом; тихая генерация цели при принятии мировых поручений; элитная
подкормка эмбиента (25%); скейлинг стартового ранга немезид от ранга охотника
(+0/+1/+2); магазин 4 ранговых меню (T1→T4, вендоры 190100-03, ранг 5 пуст);
RP-тотал — слово «немезида» убрано из всех строк; данж-анонсы: одно сообщение
присутствия с дебаунсом, убийства тихие; HP-самохил данж-немезид; аддон:
панель поручения, V2:DUNGEON mapId-матч, новые триггеры бутстрапа.
