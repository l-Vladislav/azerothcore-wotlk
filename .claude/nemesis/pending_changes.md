...
- Данж-немезиды: 3% на спавн трэша/элиток (без боссов), временные
  ...
  атмосферное сообщение на карту («Вы чувствуете присутствие сильного
  врага в этом месте», без имён/рангов, одно на весь свип); анонсы убийств
  данж-немезид тоже только в карту, не на весь сервер. Аддон-пуш при
  создании, при входе игрока и через бутстрап; вкладка «Немезиды в этой
  зоне» матчит данжи по zoneName==GetRealZoneText.
